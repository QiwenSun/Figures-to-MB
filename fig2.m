...
A1 = 5;           % Amplitude of periodic transcription
...
meanmRNAlevel_B = (V0_B + (k_on_B*V0_A*k_on_A)/(gamma_A*k_on_A + gamma_A*k_off_A)) * ...
    ...
    (A1*A2*k_on_A*k_on_B)/((k_on_A+k_off_A)*(k_on_B+k_off_B)* ...
